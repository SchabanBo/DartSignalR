# DartSignalR
Convert your C# SignalR class to dart class to use it with your projects using [signalr_core](https://pub.dev/packages/signalr_core)
Add the types you want to convert and call Run to get string that is the dart class
...
- Type: The type you want to convert to dart class, you can use ConvertRequest.For<Type>()
...
The result of this [ExampleHub](https://github.com/SchabanBo/DartSignalR/tree/master/Console/ExampleHub) is
